...
//		double metP0 = (double)met0.get(MetData.P);
	...
	//now have Qe from irrigated grass, so reduce Qg and Qh
	public HashMap<String,Double> lumps(HashMap<String,Double> rad, Cfm cfm, double metTa0, double metP0, String surf, HashMap<String,Date> Dats, double Qe)
	{
		HashMap<String,Double> returnValues = new HashMap<String,Double> ();
